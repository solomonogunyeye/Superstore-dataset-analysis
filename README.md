...
This project involves an in-depth analysis of a Superstore sales dataset. The dataset contains transactional-level information spanning multiple stores, product categories, and time periods. The goal is to uncover insights into sales trends, revenue performance, and shipping metrics to support business decision-making, optimize inventory, and improve customer experience.
